...
<li>
    ...
    <form action="<?= $this->createUrl(''); ?>" method="post">
        ...
        <input type="submit" value="elkészítés" data-mini="true" data-inline="true">
        <?php else: ?>
        <input type="submit" value="elkészítés" data-mini="true" data-inline="true" disabled="disabled">
        <?php endif; ?>
    </form>
